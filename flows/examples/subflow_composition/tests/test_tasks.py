...
class TestOrdercheckout(FlowTest):
    """
    Test suite for OrderCheckout flow
    ...
    async def test_flow_with_mocked_tasks(self):
        ...
        self.mock_task('CalculateFinalAmount', return_value={'output': 'mocked_output'})
        self.mock_task('CreateShipment', return_value={'output': 'mocked_output'})
        self.mock_task('GenerateReceipt', return_value={'output': 'mocked_output'})
        self.mock_task('GetOrderDetails', return_value={'output': 'mocked_output'})
        self.mock_task('UpdateOrderStatus', return_value={'output': 'mocked_output'})
        ...
        # self.assert_task_called('CalculateFinalAmount', times=1)
        # self.assert_task_called('CreateShipment', times=1)
        # self.assert_task_called('GenerateReceipt', times=1)
        # self.assert_task_called('GetOrderDetails', times=1)
        # self.assert_task_called('UpdateOrderStatus', times=1)
